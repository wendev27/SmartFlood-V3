...
export const sensorsMock: SensorReading[] = [
  ...
  { id: "SNS-002", barangay: "Barangay Tanyong", coordinates: "3.8m", status: "Degraded", latestReading: "1.2m", level: "Warning" },
  { id: "SNS-003", barangay: "Barangay Tanyong", coordinates: "1.2m", status: "Active", latestReading: "4.5m", level: "Normal" },
  { id: "SNS-004", barangay: "Barangay Tanyong", coordinates: "4.5m", status: "Offline", latestReading: "2.1m", level: "Critical" },
